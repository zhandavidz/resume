...
\noindent
\textbf{Academic Talent Development Program} \hfill Jun - Aug 2017, 2019\\ % Project or organization name and location
...
\begin{itemize}
    ...
    \item Utilized Sass styling and JavaScript loading to reduce code duplication and improve maintainability. %, fostering my interest in programming.
    % \item \hl{finish description}
\end{itemize}
...
\begin{itemize}
    ...
    % \item \textbf{Software:} Familiarity with Linux, the terminal
