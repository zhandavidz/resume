% places to update: GitHub (release package), /Documents, website, Handshake, Monster, Indeed, RippleMatch, LinkedIn
...
BS, Computer Science (Honors) \hfill Overall GPA: 3.97 $|$ Major GPA: 4.0 % Degree and GPA
...
\noindent
\textbf{UMass Amherst | CICS} \hfill Feb 2024 - Present \\ % Project or organization name and location
\textit{Undergraduate Course Assistant} %\hfill Anticipated Start: Feb 2023 % Position and duration
\begin{itemize}
...
\section*{SKILLS}
\begin{itemize}
    \item \textbf{Programming:} JavaScript/TypeScript, Python, Java, C, HTML/CSS/Sass, PostgreSQL, GDScript, {\fontfamily{lmodern}\selectfont \LaTeX}
